...
###############################################################################
#
# Find non valid files after remove duplicate files, such as without authors
...
def normalize_general(data: dict) -> dict:
    raw_data: dict = copy.deepcopy(data)

    name: str = get_member_recursive(raw_data, 'name')
    composition: str = get_member_recursive(raw_data, 'composition')
    therapeutic_indications: str = get_member_recursive(raw_data, 'therapeutic_indications')
    contraindications: str = get_member_recursive(raw_data, 'contraindications')
    ...
    contraindications = all_normalizations(contraindications)

    set_member_recursive(raw_data, 'name', name)
    set_member_recursive(raw_data, 'composition', composition)
    set_member_recursive(raw_data, 'therapeutic_indications', therapeutic_indications)
    set_member_recursive(raw_data, 'contraindications', contraindications)
