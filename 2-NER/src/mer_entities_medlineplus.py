...
def process_contraindications(contraindications: str, lexicons: list):
    return process_str_member('contraindications', contraindications, lexicons)
...
def process_doc(doc_file, lexicons, output_dir, blacklist) -> None:
    ...
    contraindications_lexicons = member_lexicons['contraindications']

    composition = get_member_recursive(doc, 'composition')
    therapeutic_indications = get_member_recursive(doc, 'therapeutic_indications')
    contraindications = get_member_recursive(doc, 'contraindications')
    ...
    contraindications_entities = process_contraindications(contraindications, contraindications_lexicons)

    new_doc['composition'] = composition_entities
    new_doc['therapeutic_indications'] = therapeutic_indications_entities
    new_doc['contraindications'] = contraindications_entities
